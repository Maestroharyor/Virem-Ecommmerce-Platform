...
const modalPaymentClose = (type) => {
  notification[type]({
    ...
    description:
      "Payment closed. Please click on PLACE ORDER to complete your order....",
  });
};
      ...
      <figure>
        ...
        <div className="row">
          ...
          <div className="col-sm-6 col-12">
            <div className="form-group">
              <label>
                Shipping Axis <span className="required">*</span>
              </label>
              <Form.Item
                name="shipping_axis"
                rules={[
    ...
    >
      <div className="row">
        <div className="col-lg-8">
          ...
          <div className="form-group">
            <Checkbox onChange={(e) => handleChangeDifferentAddress(e)}>
            ...
            <div className="ps-block--checkout-order">
              <div className="ps-block__content">
                ...
                <figure>
                  <figcaption>
                    <strong>Subtotal</strong>
                    <strong className="red">₦{props.cart.amount}</strong>
                  </figcaption>
                </figure>
                {shippingAxis && (
                  <figure>
