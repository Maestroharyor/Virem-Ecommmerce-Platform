            ...
            <div className="ps-container">
                <div className="ps-section__left">
                        <Slider
                            ...
                            {/* {bannersView} */}
                            <BannerItem source='/static/img/sliders/Airtime Banner 1230 x 425.jpg' key={1} redirect={true} link = 'https://topup.virem.com.ng' />
                            <BannerItem source='/static/img/sliders/Food Banner 1230 x 425.jpg' key={2} link="/shop" />
                            <BannerItem source='/static/img/sliders/Sports Banner 1230 x 425.jpg' key={2} redirect={true} link = 'https://livescores.virem.com.ng' />
                            <BannerItem source='/static/img/sliders/Groceries Banner 867 x 416.jpg' key={2} link="/shop"/>
