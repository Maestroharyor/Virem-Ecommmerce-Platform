const PrivacyPolicy = () => (
    <div className="entry-content py-5 mx-auto px-2">
		<p>{`These Terms govern your access to, usage of all content, Product and Services available at https://virem.com.ng website (the “Service”) operated by Virem (“us”, “we”, or “our”).`}</p>
...
<p>The Agreement does not transfer from Us to you any of Ours or third party intellectual property, and all right, title, and interest in and to such property will remain (as between the parties) solely with Virem and its licensors.</p>
...
<p>If you wish to terminate the Agreement or your Virem account, you may simply discontinue using our Services.</p>
...
<h2>Changes</h2>
<p>Virem reserves the right, at our sole discretion, to modify or replace these Terms at any time.</p>
